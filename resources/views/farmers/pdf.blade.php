...
<body>
    ...
    <div class="footer">
        <div style="font-weight: bold; color: #16a34a; font-size: 11pt;">🌾 LAGONGLONG FARMS - Agriculture System</div>
        <div style="margin-top: 8px;">This report contains {{ $farmers->count() }} farmer records exported on {{ now()->format('F d, Y') }}</div>
