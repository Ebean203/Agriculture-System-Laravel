...
<head>
    ...
    .subtitle { font-size: 36px; font-weight: bold; color: #16a34a; margin-bottom: 10px; }
    .title { font-size: 24px; color: #15803d; margin-bottom: 5px; font-weight: 600; }
...
<body>
    ...
    <div class="footer">
        <p style="font-size:13px; color:#374151; font-weight:600; margin:0;">Generated by System Administrator (Administrator)</p>
    </div>
